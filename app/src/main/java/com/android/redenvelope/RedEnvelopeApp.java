...
/**
 * Created by zhoulin on 16-6-23.
 */
public class RedEnvelopeApp extends Application{
    @Override
    public void onCreate() {
        // TODO Auto-generated method stub
        super.onCreate();
        AliUserTrackUtils.init(this);
        // 获取补丁，如果存在就执行注入操作
        String dexPath = Environment.getExternalStorageDirectory().getAbsolutePath().concat("/patch.jar");
        Log.e("BugFixApplication", dexPath );
    ...
    private void inject(String path) {
        ...
        try {
            ...
            Log.d("warlock","dexClassLoader  : " + dexClassLoader.getClass());
            Log.d("warlock","dexClassLoader  : " + dexClassLoader);
